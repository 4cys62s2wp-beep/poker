...
export const BADGES: BadgeDef[] = [
  ...
  { id: 'pushfold-20', icon: '🚀', title: 'Shove-Meister', description: '20 Push/Fold-Aufgaben richtig' },
  { id: 'review-clear', icon: '🧠', title: 'Alles im Kopf', description: 'Wiederholungsstapel geleert' },
