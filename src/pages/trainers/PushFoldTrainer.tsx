    ...
    <div>
      ...
      <div className="card" style={{ maxWidth: 720 }}>
        <p style={{ marginBottom: 14 }}>
          {L.introBefore}
          <strong style={{ color: 'var(--auszeichnung-hell)' }}>{L.stackApprox(chart.stack)}</strong>
          {L.introAfterStack}
          <strong style={{ color: 'var(--auszeichnung-hell)' }}>{chart.position}</strong> ({POSITION_NAMES[chart.position]})
