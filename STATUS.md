...
- **979 JavaScript-Tests grün, null übersprungen.** Typprüfung sauber,
...
- Fünf Messläufe ohne Beanstandung: `npm run wege` (Erreichbarkeit, 41 eigene
  ...
  Startseite, Hand des Tages und Lernbildschirm, 29 Schritte), `npm run pruefen` (Kontrast, Tippflächen,
